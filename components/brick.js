        ...
        <>
          <rect
            ...
            y={
              ...
              (currentBrick.current.position[1] + 1) *
                useContext(gameContext).game.gridSize
            }
            width={
              useContext(gameContext).game.gridSize *
              currentBrick.current.dim[0]
            }
            height={
              useContext(gameContext).game.gridSize *
              currentBrick.current.dim[1]
            }
            fill="#5c260f"
          />
        </>
      ...
      return (
        <>
          <rect
            ...
            width={useContext(gameContext).game.gridSize}
      ...
      return (
        <>
          ...
          <text
            ...
            y={
              useContext(gameContext).game.height -
              currentBrick.current.position[1] *
                useContext(gameContext).game.gridSize -
              2
            }
          >
